...
![image-20220317101115398](../../../images/results/img/image-20220317101115398.png)
...
![image-20220316093416477](../../../images/results/img/image-20220316093416477.png)
...
![image-20220316093922199](../../../images/results/img/image-20220316093922199.png)

&emsp;&emsp;同时可以看到创建了相关的表结构在数据库中

![image-20220316093957662](../../../images/results/img/image-20220316093957662.png)
...
![image-20220317110902636](../../../images/results/img/image-20220317110902636.png)
...
![image-20220316100439048](../../../images/results/img/image-20220316100439048.png)

&emsp;&emsp;在后台表结构也可以看到相关的信息

act_re_deployment: 流程定义部署表，每部署一次就增加一条记录

![image-20220316100532725](../../../images/results/img/image-20220316100532725.png)



act_re_procdef ：流程定义表，部署每个新的流程定义都会在这张表中增加一条记录

![image-20220316100611004](../../../images/results/img/image-20220316100611004.png)



act_ge_bytearray ：流程资源表，流程部署的 bpmn文件和png图片会保存在该表中

![image-20220316100648362](../../../images/results/img/image-20220316100648362.png)
...
![image-20220316102638015](../../../images/results/img/image-20220316102638015.png)
...
![image-20220316110406801](../../../images/results/img/image-20220316110406801.png)
...
![image-20220316111124019](../../../images/results/img/image-20220316111124019.png)



&emsp;&emsp;在此处我们直接解决掉这个请假，然后会走发送拒绝邮件的流程，这块我们需要用到JavaDelegate来触发。

![image-20220316111253702](../../../images/results/img/image-20220316111253702.png)
...
![image-20220316111913933](../../../images/results/img/image-20220316111913933.png)
...
![image-20220316202904261](../../../images/results/img/image-20220316202904261.png)

&emsp;解压缩就可以了，然后进入解压缩的目录

![image-20220316203036602](../../../images/results/img/image-20220316203036602.png)

&emsp;&emsp;直接启动即可

![image-20220316203111301](../../../images/results/img/image-20220316203111301.png)





![image-20220316203237316](../../../images/results/img/image-20220316203237316.png)
...
![image-20220316203454281](../../../images/results/img/image-20220316203454281.png)



&emsp;&emsp;这种在线更新的方式已经被官网移除了，操作不了

![image-20220316211319931](../../../images/results/img/image-20220316211319931.png)



&emsp;&emsp;这时我们就只能通过离线安装的方式来实现了，下载对应的离线文件

![image-20220316211405001](../../../images/results/img/image-20220316211405001.png)

&emsp;&emsp;安装步骤来操作，

![image-20220316211518520](../../../images/results/img/image-20220316211518520.png)



然后继续：选择**Help → Install New Software**

![image-20220316211622115](../../../images/results/img/image-20220316211622115.png)



![image-20220316211651195](../../../images/results/img/image-20220316211651195.png)

下一步

![image-20220316211729581](../../../images/results/img/image-20220316211729581.png)



再下一步

![image-20220316211802548](../../../images/results/img/image-20220316211802548.png)

然后finish。弹出如下窗口

![image-20220316212008477](../../../images/results/img/image-20220316212008477.png)
...
![image-20220316212418899](../../../images/results/img/image-20220316212418899.png)

&emsp;&emsp;然后我们可以在src/mian/resources/ 的目录下创建对应的流程图了

![image-20220316212605146](../../../images/results/img/image-20220316212605146.png)



&emsp;&emsp;看到如下的界面说明插件安装成功了

![image-20220316212720767](../../../images/results/img/image-20220316212720767.png)
...
![image-20220316214339678](../../../images/results/img/image-20220316214339678.png)

指定流程的主键

![image-20220316214430644](../../../images/results/img/image-20220316214430644.png)
...
![image-20220316214700887](../../../images/results/img/image-20220316214700887.png)
...
![image-20220316214808400](../../../images/results/img/image-20220316214808400.png)

注意：生成图片需要如下配置

![image-20220316214256235](../../../images/results/img/image-20220316214256235.png)
...
![image-20220316215805503](../../../images/results/img/image-20220316215805503.png)

然后会发现在项目的根目录下多了一个deployment文件夹，里面多了一个MyProcess.bar文件

![image-20220316215900052](../../../images/results/img/image-20220316215900052.png)

然后我们就可以把这个bar文件拷贝到IDEA中，继续部署的流程

![image-20220316215945236](../../../images/results/img/image-20220316215945236.png)
...
![image-20220316220121734](../../../images/results/img/image-20220316220121734.png)
...
![image-20220318102128672](../../../images/results/img/image-20220318102128672.png)

然后把解压缩后的两个war包拷贝到Tomcat的解压缩的webapps目录下

![image-20220318102224330](../../../images/results/img/image-20220318102224330.png)

Tomcat目录：

![image-20220318102255188](../../../images/results/img/image-20220318102255188.png)
...
![image-20220318102325924](../../../images/results/img/image-20220318102325924.png)

如果启动中出现乱码修改Tomcat的conf目录下的 logging.properties 文件中的编码

![image-20220318102446699](../../../images/results/img/image-20220318102446699.png)



如果一闪而过则检查jdk的环境变量配置。启动成功后，在浏览器中访问 http://localhost:8080/flowable-ui, 默认的账号密码是 admin/test

![image-20220318102609807](../../../images/results/img/image-20220318102609807.png)
...
![image-20220318102707368](../../../images/results/img/image-20220318102707368.png)

创建用户

![image-20220318102734238](../../../images/results/img/image-20220318102734238.png)
...
![image-20220318102817782](../../../images/results/img/image-20220318102817782.png)



授权管理

![image-20220318102859814](../../../images/results/img/image-20220318102859814.png)
...
![image-20220318101239742](../../../images/results/img/image-20220318101239742.png)

流程图界面

![image-20220318101346692](../../../images/results/img/image-20220318101346692.png)
...
![image-20220318101639424](../../../images/results/img/image-20220318101639424.png)





![image-20220318101611564](../../../images/results/img/image-20220318101611564.png)

继续完成流程图的创建

![image-20220318101810272](../../../images/results/img/image-20220318101810272.png)
...
![image-20220318103413285](../../../images/results/img/image-20220318103413285.png)

下载下来后拷贝到项目的resource目录下即可

![image-20220318103518807](../../../images/results/img/image-20220318103518807.png)
...
![image-20220318104517967](../../../images/results/img/image-20220318104517967.png)

创建一个新的应用程序，并指定相关的信息

![image-20220318104614784](../../../images/results/img/image-20220318104614784.png)

创建应用后需要指定对应的流程图

![image-20220318104703306](../../../images/results/img/image-20220318104703306.png)



![image-20220318104735714](../../../images/results/img/image-20220318104735714.png)





![image-20220318104811812](../../../images/results/img/image-20220318104811812.png)



发布应用程序

![image-20220318105045345](../../../images/results/img/image-20220318105045345.png)
...
![image-20220318105258331](../../../images/results/img/image-20220318105258331.png)



![image-20220318105315908](../../../images/results/img/image-20220318105315908.png)





![image-20220318105336107](../../../images/results/img/image-20220318105336107.png)



![image-20220318105420011](../../../images/results/img/image-20220318105420011.png)

点击显示图：

![image-20220318105444672](../../../images/results/img/image-20220318105444672.png)

也就是可以看到当前是user1来处理，user1登录后可以看到要处理的流程，user2登录是看不到的。

![image-20220318105646273](../../../images/results/img/image-20220318105646273.png)



点击完成后流程就向下一步流转了

![image-20220318105727192](../../../images/results/img/image-20220318105727192.png)



这时再通过user2登录，就可以看到对应的代办的信息

![image-20220318105808830](../../../images/results/img/image-20220318105808830.png)



![image-20220318105848185](../../../images/results/img/image-20220318105848185.png)
...
![image-20220319113106848](../../../images/results/img/image-20220319113106848.png)



![image-20220319113139646](../../../images/results/img/image-20220319113139646.png)
...
![image-20220319114011806](../../../images/results/img/image-20220319114011806.png)



![image-20220319114053252](../../../images/results/img/image-20220319114053252.png)



![image-20220319114210012](../../../images/results/img/image-20220319114210012.png)
...
![image-20220319223019186](../../../images/results/img/image-20220319223019186.png)
...
![image-20220320103803308](../../../images/results/img/image-20220320103803308.png)
...
![image-20220320103929543](../../../images/results/img/image-20220320103929543.png)
...
![image-20220320104157816](../../../images/results/img/image-20220320104157816.png)
...
![image-20220321210010518](../../../images/results/img/image-20220321210010518.png)

而且通过REV_字段来控制数据安全，也是一种乐观锁的体现了，如果要启动一个已经挂起的流程就会出现如下的错误

![image-20220321211858122](../../../images/results/img/image-20220321211858122.png)
...
![image-20220322133108405](../../../images/results/img/image-20220322133108405.png)

![image-20220322133219534](../../../images/results/img/image-20220322133219534.png)
...
![image-20220322133307195](../../../images/results/img/image-20220322133307195.png)

![image-20220322133335326](../../../images/results/img/image-20220322133335326.png)
...
![image-20220322133406398](../../../images/results/img/image-20220322133406398.png)

![image-20220322133439827](../../../images/results/img/image-20220322133439827.png)
...
![image-20220322133501720](../../../images/results/img/image-20220322133501720.png)
...
![image-20220322135040119](../../../images/results/img/image-20220322135040119.png)

![image-20220322135125703](../../../images/results/img/image-20220322135125703.png)

ACT_RU_VARIABLE  运行时变量表:会记录新的流程变量

![image-20220322135204021](../../../images/results/img/image-20220322135204021.png)
...
![image-20220322135605252](../../../images/results/img/image-20220322135605252.png)



IDENTITYLINK中会记录每次流程操作的信息

![image-20220322135636841](../../../images/results/img/image-20220322135636841.png)



![image-20220322135659671](../../../images/results/img/image-20220322135659671.png)



流程变量数据，及时key 相同，但是属于不同的流程实例相互间也是隔离的

![image-20220322135719104](../../../images/results/img/image-20220322135719104.png)
...
![image-20220322141800554](../../../images/results/img/image-20220322141800554.png)

![image-20220322141825065](../../../images/results/img/image-20220322141825065.png)
...
![image-20220322141717826](../../../images/results/img/image-20220322141717826.png)
...
![image-20220322141855401](../../../images/results/img/image-20220322141855401.png)



![image-20220322141912602](../../../images/results/img/image-20220322141912602.png)
...
![image-20220322142609163](../../../images/results/img/image-20220322142609163.png)

![image-20220322142650699](../../../images/results/img/image-20220322142650699.png)
...
![image-20220322142756867](../../../images/results/img/image-20220322142756867.png)
